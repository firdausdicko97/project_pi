  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../user/daftar.php">Daftar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../user/pengumuman.php"> Pengumuman</a>
        </li>
      </ul>
      <div class="nav-item">
        <a class="logout" href="../user/logout/logout.php">Logout</a>
      </div>
    </div>
  </nav>
